...
from saleor.purchase.models import PurchaseVariant, PurchasedItem
...
class Item(models.Model):
    return_purchase = models.ForeignKey(ReturnPurchase, related_name='return_purchase_items', on_delete=models.CASCADE)
    purchase_item = models.ForeignKey(PurchasedItem, null=True, blank=True,)
