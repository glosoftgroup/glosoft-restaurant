...
urlpatterns = [
    ...
    url(r'^detail/(?P<pk>[0-9]+)/(?P<point>[0-9]+)/$',
        permission_required('reports.view_sale_reports', login_url='not_found')
    ...
    url(r'^mrg/sales/list/items/pdf/$', sales_margin.sales_list_margin_items_pdf,
        name='reports_sales_margin_items_pdf'),

    url(r'^orders/$', permission_required('reports.view_sale_reports', login_url='not_found')
    (orders.orders_list), name='orders_list'),
    url(r'^ords/detail/(?P<pk>[0-9]+)/(?P<point>[0-9]+)/$',
        permission_required('reports.view_sale_reports', login_url='not_found')
    ...
    url(r'^orders/pdf/detail/(?P<pk>[0-9]+)/(?P<point>[0-9]+)/$',
        permission_required('reports.view_sale_reports', login_url='not_found')
    ...
    url(r'^pdf/detail/(?P<pk>[0-9]+)/(?P<point>[0-9]+)/$',
        permission_required('reports.view_sale_reports', login_url='not_found')
