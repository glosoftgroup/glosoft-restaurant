...
from . import views, pdfs, sales_margin
...
urlpatterns = [
    ...
    url(r'^pdf/credit/detail/(?P<pk>[0-9]+)/$',
        permission_required('reports.view_credit_reports', login_url='not_found')
    ...
    url(r'^sale/notifier/$', views.due_credit_notifier, name='due_credit_notifier'),
